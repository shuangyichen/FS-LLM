...
def enable_adapter(model, package, adapter, **kwargs):
    ...
    if package == 'peft':
        ...
        if adapter == 'lora':
            ...
            target_modu = [
                # "layer.12.attention.self.value","layer.12.attention.self.query",
                # "layer.13.attention.self.value","layer.13.attention.self.query",
                # "layer.14.attention.self.value","layer.14.attention.self.query",
                "layer.15.attention.self.value","layer.15.attention.self.query",
                "layer.16.attention.self.value","layer.16.attention.self.query",
                "layer.17.attention.self.value","layer.17.attention.self.query",
            ...
            peft_config = LoraConfig(task_type=TaskType.SEQ_CLS, target_modules=target_modu,  **kwargs)
